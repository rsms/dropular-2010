...
exports.init = function(args) {
    this.config = {
      'user_agent':'nodejs/'+process.version.substr(1),
...
exports.upload = function(args, cb){
  ...
  return rest.put([object.url, object.filename].join('/'), options)
    .addListener('complete', function(r){ cb(null, r); })
    .addListener('error', function(e){ cb(e); });
}
